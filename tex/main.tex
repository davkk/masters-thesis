...
% TODO: pierwsze rozwiazanie dzialalo lokalnie, ale nie w GRID + jak dziala GRID (dlaczego nie dziala?) -> dalej opisac jak to rozwiazalem
...
% \begin{figure}[ht!]
%     \centering
%     \includegraphics[width=0.5\textwidth]{../data/LHC23d1k/p-p/contamination.pdf}
%     \caption{}
...
% \begin{figure}[ht!]
%     \centering
%     \includegraphics[width=\textwidth]{../data/LHC23d1k/pi-api/contamination.pdf}
%     \caption{}
