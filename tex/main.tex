...
Illustrated in Figure \ref{fig:o2-flow}, the flow of data processing in O2Physics starts with a specialized task called "producer". It parses the data into tables with a shape well-defined as \textbf{FemtoDerived}. After preprocessing, the analysis tasks run against the tables, generating visualizations in form of histograms and other plot types.
